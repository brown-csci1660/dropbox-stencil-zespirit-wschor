...
def AsymmetricKeyGen() -> (AsymmetricEncryptKey, AsymmetricDecryptKey):
    ...
    """
    call_logger.log.append({"name": myself(), "args": locals()})
...
if __name__ == '__main__':
    ...
    cipher2 = AsymmetricEncrypt(pk, "CS166".encode())
    ...
    signature2 = SignatureSign(signing_key, data)
    print(signature)
    print(signature2)
